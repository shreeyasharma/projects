...
public class kk3 extends AppCompatActivity {
    ListView list2;
    String myJSON;
    String result1;
        ...
        l1.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                ...
                try
                {
                    ...
                    HttpPost httpPost=new HttpPost("http://seju.esy.es/addgrpcommnt1.php");
    ...
    protected void showList() {
        try {
            ...
            ListAdapter adapter = new SimpleAdapter(kk3.this, personList2, R.layout.list_item13,
