...
Button check1;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        text=(EditText)findViewById(R.id.choose1);
       ...
       uname = user.get(SessionManager.KEY_NAME);
        ...
        check1=(Button)findViewById(R.id.check);
        check1.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View v) {RequestHandler rh = new RequestHandler();
                Dialog dialog = new Dialog(add_post.this);
                dialog.setContentView(R.layout.custom);
                get();
                rad=""+text.getText().toString();

                List<NameValuePair> nameValuePairs=new ArrayList<NameValuePair>(1);
                nameValuePairs.add(new BasicNameValuePair("radius",rad));

                nameValuePairs.add(new BasicNameValuePair("latitude",""+latitude));
                nameValuePairs.add(new BasicNameValuePair("longitude",""+longitude));
                nameValuePairs.add(new BasicNameValuePair("name","sejal_goyal"));
                ...
                try
                {
                    ...
                    HttpPost httpPost=new HttpPost("http://seju.esy.es/add_address.php");
                    ...
                    String line=null;
                    int j=0;int i=0,k=0,m=0;HashMap<String,String>hash=new HashMap<>();
...
Toast.makeText(getApplicationContext(),""+l,Toast.LENGTH_LONG).show();
                ...
                Intent intent = new Intent(add_post.this, contact.class);
                add_post.this.startActivityForResult(intent,1);
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String gps_tagged=text.getText().toString();
                StringBuilder sb=new StringBuilder();
                sb.append(tag_person+",");
                sb.append(gps_tagged);
                //tag_person=tagged.getText().toString();
                uploadImage();
...
public void uploadImage()
{
    class UploadImage extends AsyncTask<Bitmap,Void,String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            loading = ProgressDialog.show(add_post.this, "Uploading...", null,true,true);
        }
...
public void get() {
    geocoder = new Geocoder(add_post.this);
    gps = new GPSTracker(add_post.this);
