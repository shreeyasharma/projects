...
public class news extends AppCompatActivity {
    ...
    public void sort(String category){
        if(category.equals("All")){
            mAdapter = new MyRecAdapter(news.this, list);
            ...
            for (DataSet a : list) {
                if (a.getCategory().equals(category)) {
                    listF.add(a);
                    mAdapter = new MyRecAdapter(news.this, listF);
                    mRecyclerView.setAdapter(mAdapter);
    ...
    public void parse(){
        ...
        try {
            Toast.makeText(news.this, "entered try json", Toast.LENGTH_LONG).show();

            JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(url, new Response.Listener<JSONObject>() {
                @Override
                public void onResponse(JSONObject response) {
                    Toast.makeText(news.this, "entered onResponse", Toast.LENGTH_LONG).show();
                    ...
                    for (int i = 0; i < articles.length(); i++) {
                        ...
                        try {
                            ...
                            e.printStackTrace();
                            Toast.makeText(news.this, "exception", Toast.LENGTH_LONG).show();
