...
public class FetchFactTask1 extends AsyncTask<Integer,Void,HashMap> {
    ...
    public FetchFactTask1(TextView outputTxt,TextView outputTxt1, ImageView outurl){
        super();
        outTxt = outputTxt;
        outTxt1 = outputTxt1;
        urlImage=outurl;
    ...
    protected HashMap<Integer[], String> doInBackground(Integer... uri) {
        ...
        HttpPost httppost = new HttpPost("http://seju.esy.es/hotcommnt.php");
