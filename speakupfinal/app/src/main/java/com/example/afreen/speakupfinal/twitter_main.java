...
public class twitter_main extends ActionBarActivity implements View.OnClickListener {

    // Note: Your consumer key and secret should be obfuscated in your source code before shipping.
    private static final String TWITTER_KEY = "N6IIdFsWsvC19xsJti5iHOU6v";
    private static final String TWITTER_SECRET = "w5t0HxuHkqCk7HU8FtNRlmkZOnlZZUmcJ72FcuM7OqAiiwHvOP";
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            case R.id.tweet_btn:
                ...
                if (utils
                        .isNetworkConnected(twitter_main.this) == false) {
                    showAlertBox();
                } else {
    ...
    protected void startWebAuthentication() {
        final Intent intent = new Intent(twitter_main.this,
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        try {
            ...
            long userID = accessToken.getUserId();
            User user1=mTwitter.showUser(mTwitter.getScreenName());
            profileImage= user1.getBiggerProfileImageURL();
            ...
            Picasso.with(getApplicationContext()).load(profileImage).into(img1);
            saveTwitterInformation(accessToken);
        } catch (Exception e) {
        }
    }
    ...
    private void showAlertBox() {
        ...
        if (mdialogBuilder == null) {
            mdialogBuilder = new AlertDialog.Builder(twitter_main.this);
    ...
    class PostTweet extends AsyncTask<String, Integer, Void> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            mPostProgress = new ProgressDialog(twitter_main.this);
