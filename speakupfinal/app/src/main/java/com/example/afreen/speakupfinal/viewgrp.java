...
public class viewgrp extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ch = (Button) findViewById(R.id.but99);
        insert3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (tt.matches("")) {
                    ...
                    Intent intent = new Intent(viewgrp.this, kk.class);
        ...
        ch.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(viewgrp.this, pie1.class);
                startActivity(intent);
            }
    ...
    protected void showList(){
        try {
            ...
            ListAdapter adapter = new SimpleAdapter(viewgrp.this, personList1, R.layout.list_item1,
                    new String[]{TAG_ID},
                    new int[]{R.id.id}
            );
...
jj=ph.name;
        ...
        try
        {
            ...
            HttpPost httpPost=new HttpPost("http://seju.esy.es/grpshow.php");
